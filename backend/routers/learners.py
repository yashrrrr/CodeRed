...
from backend.lib_db import get_db
from backend.models import Learner, Nudge, Event
from backend.services.openai_client import generate_nudge, generate_quiz
from backend.lib.risk import compute_risk, compute_and_update_all
